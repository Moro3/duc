<?php
/*
echo '<div style="padding:20px;width:100%;text-align:center;">';
echo '<h1>Обновление данных...</h1>';
echo '<br>';
echo '<h2><a href="">Попробовать снова</a></h2>';
echo '</div>';
exit;
*/
...
log_message('error', date("y.m.d H:m:s")."\t".$errno."\t".$errstr."\t".$errfile."\t".$errline);
 ...
 */
	...
	define('SYSDIR', rtrim(strrchr(trim(BASEPATH, '/'), '/'), '/'));
