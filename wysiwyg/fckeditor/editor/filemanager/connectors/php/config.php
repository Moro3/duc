...
//$Config['UserFilesPath'] = '/'.assets_uploads() ;
//$Config['UserFilesPath'] = '/uploads/';
$Config['UserFilesPath'] = $ci_fck['assets_uploads'] ;
...
$Config['QuickUploadPath']['File']		= $Config['UserFilesPath'] . 'fast/';
...
$Config['QuickUploadPath']['Image']		= $Config['UserFilesPath'] . 'fast/' ;
$Config['QuickUploadAbsolutePath']['Image']= $Config['UserFilesAbsolutePath'] ;
...
$Config['QuickUploadPath']['Flash']		= $Config['UserFilesPath'] . 'fast/' ;
...
$Config['QuickUploadPath']['Media']		= $Config['UserFilesPath'] . 'fast/' ;
