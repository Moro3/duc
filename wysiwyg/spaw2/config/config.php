...
// language
SpawConfig::setStaticConfigItem('default_lang','utf-8');
...
SpawConfig::setStaticConfigItem("dropdown_data_core_formatBlock",
  array(
    ...
    '<H6>' => 'Heading 6',
    '<pre>' => 'Preformatted',
    '<a href=javascript:void(0)>' => 'прозрачность',
    '<address>' => 'Address'
  )
);
...
SpawConfig::setStaticConfigItem("quick_links",
  array(
    'http://sinergi.ru/' => 'Сайт Южного Окружного Управления Образованием г.Москвы.',
    'http://www.educom.ru/' => 'официальный интернет-сайт Департамента образования г.Москвы',
    'http://www.uao.mos.ru/' => 'официальный сайт префектуры Южного административного округа'
  ),
...
// img core toolbars
SpawConfig::setStaticConfigItem('toolbarset_img',
  array(
    "insert" => "insert_img",
    //"tools" => "tools"
  )
...
SpawConfig::setStaticConfigItem('toolbarset_mini_img',
  array(
    "format" => "format_mini",
    "edit" => "edit",
    "tools" => "tools",
...
SpawConfig::setStaticConfigItem('toolbarset_mini_font',
  array(
    "format" => "format",
    "edit" => "edit",
    "tools" => "tools",
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    ...
    'max_upload_filesize' => 5000000,             // max upload file size allowed in bytes, or 0 to ignore
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      ...
      'params'  => array(
        'allowed_filetypes' => array('flash', 'video')
      )
    ),
    array(
      'dir'     => '/uploads/images/',
    ...
    array(
      ...
      'caption' => 'Files',
      'params'  => array(
        'allowed_filetypes' => array('documents', 'archives')
      )
    ),
  ),
  SPAW_CFG_TRANSFER_SECURE
