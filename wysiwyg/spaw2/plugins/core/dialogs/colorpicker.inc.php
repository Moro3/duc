...
<tr>
  <td>
    <div class="groupbox">
      ...
      <tr>
        <td rowspan="3" id="color_sample" style="width: 40px; border: 1px solid black;">&nbsp;</td>
      ...
      <tr>
        <td class="spawCPpredefColor" style="background: <?php echo (empty($predef_colors[16])?'#ff5503':$predef_colors[16])?>; cursor: pointer;" onclick="SpawColorPicker.setCurrentColorFromHTML(this.style.backgroundColor, this);" title="оранжевый">&nbsp;</td>
        <td class="spawCPpredefColor" style="background: <?php echo (empty($predef_colors[17])?'#505660':$predef_colors[17])?>; cursor: pointer;" onclick="SpawColorPicker.setCurrentColorFromHTML(this.style.backgroundColor, this);" title="серый">&nbsp;</td>
        <td class="spawCPpredefColor" style="background: <?php echo (empty($predef_colors[18])?'#f97009':$predef_colors[18])?>; cursor: pointer;" onclick="SpawColorPicker.setCurrentColorFromHTML(this.style.backgroundColor, this);" title="оранжевый (для ссылки)">&nbsp;</td>
        <td class="spawCPpredefColor" style="background: <?php echo (empty($predef_colors[19])?'#3255b3':$predef_colors[19])?>; cursor: pointer;" onclick="SpawColorPicker.setCurrentColorFromHTML(this.style.backgroundColor, this);" title="синий (для ссылки)">&nbsp;</td>
        <td class="spawCPpredefColor" style="background: <?php echo (empty($predef_colors[20])?'#e00000':$predef_colors[20])?>; cursor: pointer;" onclick="SpawColorPicker.setCurrentColorFromHTML(this.style.backgroundColor, this);" title="красный">&nbsp;</td>
