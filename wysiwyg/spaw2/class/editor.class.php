  ...
  function getHtml()
  {
    ...
    if (SpawAgent::getAgent() != SPAW_AGENT_UNSUPPORTED)
    {
      ...
      foreach($this->pages as $pname => $page)
      {
        ...
        //$pagetpl .= '<iframe name="'.$pname.'_rEdit" id="'.$pname.'_rEdit" class=txt1 style="width: 100%; height: '.$this->height.'; frameborder="yes" src="'.SpawConfig::getStaticConfigValue("SPAW_DIR").'empty/empty.html?'.microtime().'"></iframe>';
