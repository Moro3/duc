...
*/
	...
	$config['tables']['meta']    = 'ion_meta';

	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = 'http://'.$_SERVER['SERVER_NAME'];

	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "admin@".ltrim($_SERVER['SERVER_NAME'],'www.');

	/**
	 * Page auth,
	 */
	$config['page_auth']		   = "/a123";

	/**
	 * Page login in,
	 */
	$config['page_in']		   = "/adminka";
