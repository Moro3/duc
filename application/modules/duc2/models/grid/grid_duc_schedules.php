...
class grid_duc_schedules extends jqGrid
{
    ...
    protected function init()
    {
        ...
        $this->params['groups_ext'] = Modules::run('duc/duc_groups/MY_data_array_one',
        								...
        								'main.id',
        								//select
        								array('main.name',  //'main.paid', //'main.active',
        									 //'teacher.surname', 'teacher.name',
                                              //'case when main.active == 1 then \'Да\' else \'Нет\' end'
                                              //'IF(main.active = \'1\', \'ДА\', \'Нет\')'
                                              //'case main.active when \'1\' then act when \'0\' then pass end as actcol'
                                              'encode' => array( 'CASE main.paid WHEN main.paid=1 THEN \'да\' ELSE \'нет\' END as paid',
                                              					'CASE main.active WHEN main.active=1 THEN \'да\' ELSE \'нет\' END as active',
                                              ),
        								),
        								//where
        								false,
                                        ...
                                        array('!' => ' ',
                                        	...
                                        	'teacher.name' => array('prefix' => '',
                                        						'suffix' => ';',
                                        	),
                                        	'active' => array('prefix' => 'Активно:',
                                        						'suffix' => ';',
                                        	),
                                        	'paid' => array('prefix' => 'Платно:',
                                        						'suffix' => ';',
                                        	),
                                        )
        ...
        $this->params['teachers'] = Modules::run('duc/duc_teachers/MY_data_array_one',
        								//key
        								'id',
        								//select
        ...
        */
        ...
        $this->cols = array(
            ...
            'id_group'   => array('label' => lang('duc_group'),
                                   ...
                                   'encode' => false,
                                   //'stype' => 'select',
                                   'replace' => array(0=>'нет') + $this->params['groups_ext'],
                                   ...
                                   //'replace' => $this->params['categories'],
                                   'searchoptions' => array(
                                        				'value' => new jqGrid_Data_Value($this->params['groups_ext'], 'All'),
                                        				//'value' => array('' => 'All') + $this->params['categories'],
                                        				//'onSelect'       => new jqGrid_Data_Raw('function(){$grid[0].triggerToolbar();}'),
                  				   ),
   			),
   			/*
   			'group_number'   => array('label' => lang('duc_group_number'),
                                   'hidden' => true,
                                   'width' => 50,
                                   'align' => 'left',
                                   'editable' => true,
