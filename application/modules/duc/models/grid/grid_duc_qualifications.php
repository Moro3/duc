<?php
class grid_duc_qualifications extends jqGrid
{
    protected function init()
    {
        $this->CI = &get_instance();
        $this->table = 'duc_qualifications';

        $this->query = "
            SELECT {fields}
            FROM duc_qualifications AS object
            WHERE {where}
        ";
	...
	protected function renderGridUrl(){
        return '/grid/duc_qualifications/duc/grid/';
    }
    ...
    */
    protected function opDel($id) {
        ...
        if($objs = $this->search_id_object($id, 'id_qualification')){
