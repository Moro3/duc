<?php
class grid_menus_types extends jqGrid
{
	...
	protected function renderGridUrl(){
        return '/grid/menus_types/menus/grid/';
    }
    ...
    */
    protected function opEdit($id, $data) {
    	if(Modules::run('menus/menus_types/check_double_name', $data['name'], $id)){    		throw new jqGrid_Exception('Такое имя уже используется, придумайте другое');
    	}
    	if(Modules::run('menus/menus_types/check_double_alias', $data['alias'], $id)){
    ...
    */
    protected function opAdd($data) {
         if(Modules::run('menus/menus_types/check_double_name', $data['name'])){
    		throw new jqGrid_Exception('Такое имя уже используется, придумайте другое');
    	}
    	if(Modules::run('menus/menus_types/check_double_alias', $data['alias'])){
    		throw new jqGrid_Exception('Такой псевдоним уже используется, придумайте другой');
    	}
        parent::opAdd($data);
    }
