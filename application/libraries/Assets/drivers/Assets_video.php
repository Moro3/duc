...
class Assets_video extends CI_Driver
{
    private $tags_open = "";
    ...
    private $tags_file = "";
        ...
        /**
         *  Загрузка файла видеоизображения
         * @param type $file
         * @param type $module
         * @return type
         */
         public function load($file , $_module = '', $config = array()) {
             ...
             if($this->_load_file($file, $_module, 'video', $config)){
                    return true;
                }
                return false;
	}
        ...
        function out($file = false, $module = '', $config = array(), $return = false){
            ...
            $arr = $this->_out($file, $module, 'video', $config, $return);
        ...
        function file($file = false, $module = '', $config = array(), $return = true){
            $result = $this->_file($file, $module, 'video', $config);
