...
class Assets_arj extends CI_Driver
{
    private $tags_open = "";
    ...
    private $tags_file = "";
         ...
         */
         public function load($file , $_module = '', $config = array()) {
             ...
             if($this->_load_file($file, $_module, 'arj', $config)){
                    return true;
                }
                return false;
	}
        ...
        function out($file = false, $module = '', $config = array(), $return = false){
            ...
            $arr = $this->_out($file, $module, 'arj', $config, $return);
        ...
        function file($file = false, $module = '', $config = array(), $return = true){
            $result = $this->_file($file, $module, 'arj', $config);
